/* global angular, localStorage, CONF */
...
.factory('Config', function ($rootScope, $ionicLoading) {
  ...
  configService.getProfessionalsPageSize = function () {
    return configService.PAGESIZE_PROFESSIONAL
  }

  configService.getServicesPageSize = function () {
    return configService.PAGESIZE_SERVICES
  }
